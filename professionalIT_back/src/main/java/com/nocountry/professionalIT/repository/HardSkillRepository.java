...
/**
 * Repository interface for managing operations on the {@link HardSkillEntity} entity.
 ...
 * @since 2024-02-26
 */
public interface HardSkillRepository extends JpaRepository<HardSkillEntity, Integer> {
}
