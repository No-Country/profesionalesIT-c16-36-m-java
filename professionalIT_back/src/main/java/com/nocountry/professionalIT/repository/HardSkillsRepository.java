...
/**
 * Repository interface for managing operations on the {@link HardSkillsEntity} entity.
 ...
 * @since 2024-02-26
 */
public interface HardSkillsRepository extends JpaRepository<HardSkillsEntity, Integer> {
}
