...
public class UserController {
    ...
    @PutMapping("{userId}")
    public ResponseEntity<UserEntity> updateUser(@PathVariable UUID userId, @RequestBody UserEntity updatedUser) {
    ...
    public ResponseEntity<UserEntity> disableUser(@PathVariable UUID userId) {
